...
if __name__ == "__main__":
    ...
    data_interface = DInterface(data_dir=r'./test_data/', batch_size=2)
    data_interface.setup(stage="fit")
    data_interface.setup(stage="test")
    
    print(data_interface.train_set[0])
    print(data_interface.train_set[1])
    dataloader = data_interface.train_dataloader()
    batch_size = dataloader.batch_size
    print(batch_size)
    
    # TODO: Need to fit to different shapes of data
    # batch = next(iter(dataloader))  # batch in the form of list
    # print(batch[0].shape)
    # print(batch[1].shape)
